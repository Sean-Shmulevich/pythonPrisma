...
SCHEMA_PATH = Path('/Users/seanshmulevich/Code/pythonPrisma/venv/schema.prisma')
...
class Prisma:
    ...
    def __init__(
        ...
        *,
        ...
        self.profile = actions.ProfileActions(self, models.Profile)
        self.post = actions.PostActions(self, models.Post)
        self.thread = actions.ThreadActions(self, models.Thread)
